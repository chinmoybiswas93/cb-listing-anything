		...
		<table class="form-table">
			<tbody>
				<tr>
					...
					<td>
						<input type="text" id="listing_price" name="listing_price" value="<?php echo esc_attr( $price ); ?>" class="regular-text" placeholder="<?php esc_attr_e( 'e.g., $99.99', 'cb-listing-anything' ); ?>" />
				...
				<tr>
					...
					<td>
						<input type="text" id="listing_location" name="listing_location" value="<?php echo esc_attr( $location ); ?>" class="regular-text" placeholder="<?php esc_attr_e( 'e.g., New York, NY', 'cb-listing-anything' ); ?>" />
				...
				<tr>
					...
					<td>
						<input type="text" id="listing_address" name="listing_address" value="<?php echo esc_attr( $address ); ?>" class="regular-text" placeholder="<?php esc_attr_e( 'Street address', 'cb-listing-anything' ); ?>" />
					</td>
				</tr>
				<tr>
					<th scope="row">
				...
				<tr>
					...
					<td>
						<input type="email" id="listing_contact_email" name="listing_contact_email" value="<?php echo esc_attr( $contact_email ); ?>" class="regular-text" placeholder="<?php esc_attr_e( 'contact@example.com', 'cb-listing-anything' ); ?>" />
					</td>
				</tr>
				<tr>
					<th scope="row">
					...
					<td>
						<input type="tel" id="listing_contact_phone" name="listing_contact_phone" value="<?php echo esc_attr( $contact_phone ); ?>" class="regular-text" placeholder="<?php esc_attr_e( '+1 (555) 123-4567', 'cb-listing-anything' ); ?>" />
					</td>
				</tr>
				<tr>
					<th scope="row">
					...
					<td>
						<input type="url" id="listing_website" name="listing_website" value="<?php echo esc_attr( $website ); ?>" class="regular-text" placeholder="<?php esc_attr_e( 'https://example.com', 'cb-listing-anything' ); ?>" />
					</td>
				</tr>
			</tbody>
		</table>
