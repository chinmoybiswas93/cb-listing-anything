...
/**
 * Listing post type labels and registration args.
 */
class PostType {

	/** Post type slug. */
	public const POST_TYPE = 'cb_listing';

	/**
	 * Get labels for the listing post type.
	 *
	 * @return array
	 */
	...
	/**
	 * Get registration args for the listing post type (without labels).
	 *
	 * @return array
	 */
