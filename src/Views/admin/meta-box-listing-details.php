...
// If enabled fields are not provided, treat all fields as enabled for backward compatibility.
if ( ! isset( $enabled_fields ) || ! is_array( $enabled_fields ) || empty( $enabled_fields ) ) {
	$enabled_fields = ListingMeta::fields();
}
?>
<div class="cb-listing-meta-box">
	...
	<?php if (
		...
		<div class="cb-listing-meta-box__row">
			<?php if ( in_array( 'listing_price', $enabled_fields, true ) ) : ?>
			...
			<?php endif; ?>
			<?php if ( in_array( 'listing_location', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
		...
		<?php if ( in_array( 'listing_description', $enabled_fields, true ) ) : ?>
			<div class="cb-listing-meta-box__row cb-listing-meta-box__row--full">
				<div class="cb-listing-meta-box__field">
					<label for="listing_description"><?php esc_html_e( 'Description', 'cb-listing-anything' ); ?></label>
					<?php
					wp_editor(
						$values['listing_description'],
						'listing_description',
						array(
							'textarea_name' => 'listing_description',
							'media_buttons' => false,
							'textarea_rows' => 5,
							'teeny'         => true,
						)
	...
	<?php if (
		in_array( 'listing_address', $enabled_fields, true ) ||
		in_array( 'listing_city', $enabled_fields, true ) ||
		in_array( 'listing_state', $enabled_fields, true ) ||
		in_array( 'listing_zip_code', $enabled_fields, true ) ||
		in_array( 'listing_country', $enabled_fields, true )
	) : ?>
		<h3 class="cb-listing-meta-box__section"><?php esc_html_e( 'Address', 'cb-listing-anything' ); ?></h3>

		<div class="cb-listing-meta-box__row">
			<?php if ( in_array( 'listing_address', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
			...
			<?php endif; ?>
			<?php if ( in_array( 'listing_city', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
		...
		<div class="cb-listing-meta-box__row">
			<?php if ( in_array( 'listing_state', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
			...
			<?php endif; ?>
			<?php if ( in_array( 'listing_zip_code', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
		...
		<div class="cb-listing-meta-box__row">
			<?php if ( in_array( 'listing_country', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
	...
	<?php if (
		in_array( 'listing_contact_email', $enabled_fields, true ) ||
		in_array( 'listing_contact_phone', $enabled_fields, true ) ||
		in_array( 'listing_website', $enabled_fields, true )
	) : ?>
		<h3 class="cb-listing-meta-box__section"><?php esc_html_e( 'Contact', 'cb-listing-anything' ); ?></h3>

		<div class="cb-listing-meta-box__row">
			<?php if ( in_array( 'listing_contact_email', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
			...
			<?php endif; ?>
			<?php if ( in_array( 'listing_contact_phone', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
		...
		<div class="cb-listing-meta-box__row">
			<?php if ( in_array( 'listing_website', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
	...
	<?php if (
		in_array( 'listing_social_facebook', $enabled_fields, true ) ||
		in_array( 'listing_social_twitter', $enabled_fields, true ) ||
		in_array( 'listing_social_instagram', $enabled_fields, true ) ||
		in_array( 'listing_social_linkedin', $enabled_fields, true ) ||
		in_array( 'listing_social_youtube', $enabled_fields, true )
	) : ?>
		<h3 class="cb-listing-meta-box__section"><?php esc_html_e( 'Social Links', 'cb-listing-anything' ); ?></h3>

		<div class="cb-listing-meta-box__row">
			<?php if ( in_array( 'listing_social_facebook', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
			...
			<?php endif; ?>
			<?php if ( in_array( 'listing_social_twitter', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
		...
		<div class="cb-listing-meta-box__row">
			<?php if ( in_array( 'listing_social_instagram', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
			...
			<?php endif; ?>
			<?php if ( in_array( 'listing_social_linkedin', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
		...
		<div class="cb-listing-meta-box__row">
			<?php if ( in_array( 'listing_social_youtube', $enabled_fields, true ) ) : ?>
				<div class="cb-listing-meta-box__field">
	...
	<?php if (
		in_array( 'listing_opening_time', $enabled_fields, true ) ||
		in_array( 'listing_closing_time', $enabled_fields, true ) ||
		in_array( 'listing_working_days', $enabled_fields, true )
	) : ?>
		<h3 class="cb-listing-meta-box__section"><?php esc_html_e( 'Business Hours', 'cb-listing-anything' ); ?></h3>

		<?php if ( in_array( 'listing_opening_time', $enabled_fields, true ) || in_array( 'listing_closing_time', $enabled_fields, true ) ) : ?>
			<div class="cb-listing-meta-box__row">
				<?php if ( in_array( 'listing_opening_time', $enabled_fields, true ) ) : ?>
					<div class="cb-listing-meta-box__field">
				...
				<?php endif; ?>
				<?php if ( in_array( 'listing_closing_time', $enabled_fields, true ) ) : ?>
					<div class="cb-listing-meta-box__field">
		...
		<?php if ( in_array( 'listing_working_days', $enabled_fields, true ) ) : ?>
			<div class="cb-listing-meta-box__row cb-listing-meta-box__row--full">
				<div class="cb-listing-meta-box__field">
	...
	<?php if ( in_array( 'listing_gallery', $enabled_fields, true ) ) : ?>
